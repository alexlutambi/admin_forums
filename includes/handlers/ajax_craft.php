...
$sql_customer_request_color = " SELECT *, (SELECT COUNT(*) FROM tbl_fundi_registered_professional WHERE tbl_fundi_registered_professional.professional_id = tbl_fundi_professional.professional_id) AS total_fundi FROM tbl_fundi_professional ORDER BY total_fundi DESC;";
...
array_push($tamarind_customer_request_colors, array(
	...
	"is_active"=>$row_professionals[2],"professional_hint"=>$row_professionals[3],"professional_header"=>$row_professionals[4],"professional_btn"=>$row_professionals[5],"professional_icon"=>$row_professionals[6],
  "professional_icon_color_thumb"=>$row_professionals[7],"professional_icon_color"=>$row_professionals[8],
  "created"=>$row_professionals[9],"total_fundi"=>$row_professionals[10]));
