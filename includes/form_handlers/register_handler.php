...
$reg_admin_group_code = ""; //reg admin group code
$date = ""; //Sign up date 
...
if(isset($_POST['register_button'])){
	...
	//admin group code
	$reg_admin_group_code = strip_tags($_POST['reg_admin_group_code']); //Remove html tags
	$reg_admin_group_code = str_replace(' ', '', $reg_admin_group_code); //remove spaces
	$reg_admin_group_code = ucfirst(strtolower($reg_admin_group_code)); //Uppercase first letter
