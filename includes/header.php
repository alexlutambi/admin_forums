...
<body id="body-main" server_link = "<?php echo web_start_smart_link(); ?>" >

	<div class="top_bar"> 

		<div class="logo">
			<a href="index.php">FundiForumsAdmin</a>
		</div>


		<div class="search">

			<form id="search-form" class="search-form" action="search_admin.php" method="GET" name="search_form">
				<input type="text" onkeyup="getLiveSearchUsers(this.value, '<?php echo $userLoggedIn; ?>')" name="q" placeholder="Search..." autocomplete="off" search_user_type="admin" id="search_text_input" class="search-text-input">
...
<?php
function web_start_smart_link(){

  return http_or_https()."://".$_SERVER['HTTP_HOST']."/";
}
