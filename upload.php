...
***********************************************************/	
	...
	$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/fundiForums/fundi_smarts/admin_forums/assets/images/profile_pics';
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		header("Location: profile_admin.php?profile_username=".$userLoggedIn);
