...
$usersReturnedQuery = mysqli_query($con, "SELECT * FROM tbl_mafundi WHERE fundi_id LIKE '$query%' LIMIT 8");
}
else {
	$usersReturnedQuery = mysqli_query($con, "SELECT * FROM tbl_mafundi WHERE shop_name LIKE '%$query%' OR username LIKE '%$query%' LIMIT 8");
}
